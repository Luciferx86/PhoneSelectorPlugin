...
public class PhoneSelectorPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {

    private static final String TAG = "PhoneSelector";
    private static final String CHANNEL = "luciferx86.flutter.plugins.phoneselector";
    private static final String EVENT_CHANNEL = "luciferx86.flutter.plugins.phoneselectorevent";
    ...
    private PhoneSelectorDelegate delegate;
    ...
    public static void registerWith(final Registrar registrar) {
        ...
        final PhoneSelectorPlugin plugin = new PhoneSelectorPlugin();
    ...
    private void setup(
        ...
        this.delegate = new PhoneSelectorDelegate(activity);
